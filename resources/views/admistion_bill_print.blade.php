...
<body>
        ...
        <div class="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">CASE TYPE:&nbsp;
                            <span>{{ $admistion->CASE_TYPE }}</span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">IN Out:&nbsp;
                            <span>{{ date('d-M-y h:i:s A', strtotime($admistion->IN_OUT)) }}</span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">DISCHARGE DATE:&nbsp;
                            <span>{{ date('d-M-y h:i:s A', strtotime($admistion->DISCHARGE_DATE)) }}</span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">PAT REFERED BY:&nbsp;
                            <span>{{ App\Models\PatReferedBy::getPatReferedById($admistion->PAT_REFERED_BY) }}</span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">PRIVATE/SEHAT CARD:&nbsp;
                            <span>{{ App\Models\Roomes::getRoomById($admistion->PRIVATE_SEHAT_CARD) }}</span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">ROOM TYPE:&nbsp;
                            <span>{{ $admistion->ROOM_TYPE }}</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-center" style="font-weight: 600;">
                        ...
                        @endphp
                        @foreach ($buss as $val)
                            {{ App\Models\WalkingTestMdcn::getLabPriceById($val, $admistion->PRIVATE_SEHAT_CARD) }}.00
                            <br>
                        @endforeach
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10 text-right" style="font-weight: 600;">
                        <b>Generator/UPS charge</b>
                    </div>
                    <div class="col-md-2" style="font-weight: 600;">
                        {{ $admistion->procedure }}.00</div>
                    <div class="col-md-10 text-right" style="font-weight: 600;">
                        <b>Lab Test Bill</b>
                    </div>
                    <div class="col-md-2" style="font-weight: 600;">
    ...
    <script>
        $(document).ready(function() {
            window.print();
            setTimeout(function() {
                window.location.href = 'ADMISIONES/manage'
            }, 1000);
        });
    </script>
</body>
