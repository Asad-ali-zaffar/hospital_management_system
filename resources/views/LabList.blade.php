                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="{{$url}}" method="post">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <input type="number" name="lb_test_price" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{old('lb_test_price')}}" />
                                ...
                                <label for="basic-url" class="required form-label">Lab number</label>
                                    ...
                                    <div class="input-group input-group-solid mb-5">
                                        ...
                                        <input type="number" name="lab_no" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{old('lab_no')}}" min="0" maxlength="11" />
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <input type="date" name="lb_date" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{old('lb_date')}}" />
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <input type="datetime-local" name="d_t_blood_sample_colecte" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{old('d_t_blood_sample_colecte')}}" />
                                    <span class="input-group-text">00-00-0000</span>
                                    <span class="text-danger">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    <span class="input-group-text "><i class="fa fa-clock" aria-hidden="true"></i></span>
                                    <input type="datetime-local" name="d_t_reporting_of_test_results" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{old('d_t_reporting_of_test_results')}}" />
                                    <span class="input-group-text">00-00-0000</span>
                                    <span class="text-danger">
