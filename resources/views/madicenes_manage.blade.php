                                ...
                                <table id="kt_datatable_example_5"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{$val->madi_type}}</td>
                                            <td class="text-center">{{$val->madi_priceP}}</td>
                                            <td class="text-center">{{$val->madi_priceS}}</td>
                                            <td class="text-center"><span><a href="{{url('Madicenes/edit')}}/{{$val->madi_id}}" data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                            class="fas fa-edit btn btn-sm btn-light-success m-r-5">&nbsp;Edit</i> </a><a href="{{url('Madicenes/delete')}}/{{$val->madi_id}}"
