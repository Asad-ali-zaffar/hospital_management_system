...
Route::post('/forget_password',[LoginController::class,'sendLink_chengPassword']);
Route::get('/change_password/{token?}',[LoginController::class,'change_password'])->name('reset.password.form');
Route::post('/change_password',[LoginController::class,'change_password_store']);
//lab route
...
Route::get('/test-Bill_print',[WalkingTestMdcnController::class,'test_Bill_print']);
Route::get('/mdcn-Bill_print',[WalkingTestMdcnController::class,'mdcn_Bill_print']);
